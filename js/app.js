(() => {
  ...
  function de({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function d() {
      ...
      if (
        ("fraction" === s.type &&
          (d.find(oe(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          d.find(oe(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let t;
    ...
    function c() {
      ...
      if ("bullets" === t.type) {
        ...
        n.html(r), (e.pagination.bullets = n.find(oe(t.bulletClass)));
      }
      "fraction" === t.type &&
        ((r = t.renderFraction
    ...
    function p() {
      ...
      0 !== s.length &&
        (e.params.uniqueNavElements &&
          ...
          ((s = e.$el.find(t.el)),
          s.length > 1 &&
            (s = s.filter((t) => C(t).parents(".swiper")[0] === e.el))),
        ...
        t.clickable &&
          s.on("click", oe(t.bulletClass), function (t) {
            t.preventDefault();
    ...
    function u() {
      ...
      s.removeClass(t.hiddenClass),
        ...
        t.clickable && s.off("click", oe(t.bulletClass));
    }
    s("init", () => {
      p(), c(), d();
    }),
      ...
      s("click", (t, s) => {
        ...
        if (
          ...
          r.length > 0 &&
          !C(n).hasClass(e.params.pagination.bulletClass)
        ) {
          if (
            e.navigation &&
  ...
  window.addEventListener("load", function (e) {
    !(function () {
      if ((ce(), document.querySelector(".main__slider"))) {
        new re(".main__slider", {
          modules: [le, de],
          observer: !0,
          observeParents: !0,
        ...
        let e = document.querySelectorAll(".slide-main__img"),
          t = document.querySelectorAll(
            ".slide-main__navigation .swiper-pagination-bullet"
          );
      ...
      document.querySelector(".popular__slider") &&
        new re(".popular__slider", {
          ...
          speed: 800,
          pagination: {
            el: ".pop-slide__counter",
            clickable: !0,
            type: "fraction",
          },
          navigation: {
            nextEl: ".pop-slide__controll .pop-slide__next",
            prevEl: ".pop-slide__controll .pop-slide__prev",
          },
          on: {},
        }),
        document.querySelector(".brands__slider") &&
          new re(".brands__slider", {
            modules: [le, de],
            observer: !0,
            observeParents: !0,
            slidesPerView: 5,
            ...
            loop: !0,
            navigation: {
              nextEl: ".brands__control .brands__next",
              prevEl: ".brands__control .brands__prev",
            },
            breakpoints: {
              320: { slidesPerView: 1 },
              500: { slidesPerView: 2 },
  ...
  new ue("max").init();
  let he = document.querySelector(".menu-sidebar__icon"),
    fe = document.querySelector(".menu-sidebar__content");
  he &&
    he.addEventListener("click", function (e) {
      he.classList.toggle("_active"), fe.classList.toggle("_active");
    }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
